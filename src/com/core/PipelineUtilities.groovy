...
class PipelineUtilities implements Serializable {
    ...
    def buildDockerImage(service_location) {
        ...
        this.context.checkout([$class: 'GitSCM', branches: [[name: "master"]], doGenerateSubmoduleConfigurations: false, extensions: [cleanBeforeCheckout: false, cleanCheckout: false], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'cfb2df52-09d4-4f27-ad17-71a58c4995d9', url: 'https://github.com/nexmoinc/core-ci']]])
